...
"""
# CROSS!
python finetune.py --trn_data ../data/sc-stance/L1/sc-stance-train.csv --dev_data ../data/sc-stance/L1/sc-stance-dev.csv --num_classes 2 --model ../models/bert2.pt --save_to ../models/adapter-sc-L1.pt  --legal_adapter True

python finetune.py --trn_data ../data/sc-stance/L2/sc-stance-neu-train.csv --dev_data ../data/sc-stance/L2/sc-stance-neu-dev.csv --num_classes 3 --model ../models/bert.pt --save_to ../models/adapter-sc-L2.pt  --legal_adapter True
...
(18)
python finetune.py --trn_data ../data/sc-stance/L2/sc-stance-neu-train.csv --dev_data ../data/sc-stance/L2/sc-stance-neu-dev.csv --num_classes 3 --model ../models/long-bert.pt --save_to ../models/long-sc-L2.pt 
python eval.py --test_data ../data/sc-stance/L2/sc-stance-neu-test.csv --model ../models/long-sc-L2.pt 


# TRUMP CARD
python finetune.py --trn_data ../data/VAST/vast_train.csv --dev_data ../data/VAST/vast_dev.csv --num_classes 3 --model ../models/bert.pt --save_to ../models/VAST.pt 
python finetune.py --trn_data ../data/sc-stance/L2/sc-stance-neu-train.csv --dev_data ../data/sc-stance/L2/sc-stance-neu-dev.csv --num_classes 3 --model ../models/VAST.pt --save_to ../models/VAST-SC.pt --legal_adapter True
python eval.py --test_data ../data/sc-stance/L2/sc-stance-neu-test.csv --model ../models/VAST-SC.pt
...
if __name__ == '__main__':
    ...
    if args.model.split('/')[-1].split('-')[0] == 'legal':
        ...
        model = AutoModelForSequenceClassification.from_pretrained("nlpaueb/legal-bert-base-uncased", num_labels=args.num_classes, output_hidden_states=True, attention_probs_dropout_prob=0.4,hidden_dropout_prob=0.4)
        model.load_state_dict(torch.load(args.model))
    elif args.model.split('/')[-1].split('-')[0] == 'long':
        print('Using longformer!')
        tokenizer = LongformerTokenizer.from_pretrained("allenai/longformer-base-4096") 
        model = AutoModelForSequenceClassification.from_pretrained("allenai/longformer-base-4096", num_labels=args.num_classes, output_hidden_states=True, attention_probs_dropout_prob=0.4,hidden_dropout_prob=0.4)#BertModel(BertConfig()) #AutoModelForSequenceClassification.from_config(config)
        model.load_state_dict(torch.load(args.model))
    else:
        print('Using bert-base-uncased')
        tokenizer = BertTokenizerFast.from_pretrained('bert-base-uncased') 
        model = AutoModelForSequenceClassification.from_pretrained("bert-base-uncased", num_labels=args.num_classes, output_hidden_states=True, attention_probs_dropout_prob=0.4,hidden_dropout_prob=0.4)
        model.load_state_dict(torch.load(args.model))
    ...
    if not args.simple:
        train_dataloader = DataLoader(StanceDataset(df_train['text'],df_train['target'],df_train['label'], tokenizer), batch_size=16)
        val_dataloader = DataLoader(StanceDataset(df_dev['text'],df_dev['target'],df_dev['label'], tokenizer), batch_size=16)
        #train_dataloader = DataLoader(StanceDataset(df_train['post'],df_train['topic_str'],df_train['label'], tokenizer), batch_size=16)
        #val_dataloader = DataLoader(StanceDataset(df_dev['post'],df_dev['topic_str'],df_dev['label'], tokenizer), batch_size=16)
    else:
        train_dataloader = DataLoader(SimpleDataset(df_train['text'],df_train['label'], tokenizer), batch_size=16)
        val_dataloader = DataLoader(SimpleDataset(df_dev['text'],df_dev['label'], tokenizer), batch_size=16)
